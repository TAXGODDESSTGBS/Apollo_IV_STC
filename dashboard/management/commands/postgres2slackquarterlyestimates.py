...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        all_messages = intake_list_str + "\n\n"
        client = WebClient(token="xoxp-3872107291-218743594772-1776614401779-db5222da76a35774b150fde28d655c18")

        try:
            response = client.chat_postMessage(channel='#reports_quarterlyestimates-tax-projections-qtrlyestimates', text=all_messages)
