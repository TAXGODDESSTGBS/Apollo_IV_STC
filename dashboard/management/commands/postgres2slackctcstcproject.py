...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        all_messages = intake_list_str + "\n\n"
        client = WebClient(token="xoxp-3872107291-218743594772-1776366646114-002824af23ad5ba94eb1655739a8b639")

        try:
            response = client.chat_postMessage(channel='#reports_dmt-project-stc-dmt', text=all_messages)
