...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        all_messages = intake_list_str + "\n\n"
        client = WebClient(token="xoxp-3872107291-218743594772-1761640755607-fd3bb0019ee7befd2c552f42b6a42d60

")

        try:
            response = client.chat_postMessage(channel='#reports_sales-tax-return', text=all_messages)
