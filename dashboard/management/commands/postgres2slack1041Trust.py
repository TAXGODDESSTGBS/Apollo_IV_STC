...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        all_messages = intake_list_str + "\n\n"
        client = WebClient(token="xoxp-3872107291-218743594772-1800265561280-e9a4a2da0ed799af4fc1ccf613782915")

        try:
            response = client.chat_postMessage(channel='#reports_13wcf-client-project-bookkeeping ', text=all_messages)
